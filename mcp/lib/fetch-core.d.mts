...
export declare const MAX_HEADING_LEN: number
export declare const MAX_HEADINGS_LISTED: number

export declare function redactSecrets(text: string | null | undefined): { text: string; count: number }
export declare function validateFetchArgs(args: unknown): { name: string; max_chars?: number; heading?: string }
