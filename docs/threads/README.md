...
- [0002 — Phase 1 memory ingestion unit QC](0002-phase1-memory-ingestion-qc.md) — **BLOCKED** (round 3; Atlas building)
- [0003 — Token economy / context-loading strategy](0003-token-economy.md) — **OPEN** (Aegis to weigh in)
