...
- [0007 — MCP `remember` (write slice)](0007-mcp-remember.md) — ✅ **`0009` APPLIED + gate PASSED + live-verified** (2026-06-15): DB gate (defs/ACLs, bidirectional+NULL collision fail-closed, atomic rollback, bounds, secret/byte rejection) **+ concurrent same-name test (5 rounds, exactly-one-wins) + live MCP smoke test** (remember/log_update/recall end-to-end, real operator). Team seeded (7 members, no invite emails). Migrations 0001–0009 live; baseline 118/81/0/7. Awaiting Aegis **final sign-off**.
