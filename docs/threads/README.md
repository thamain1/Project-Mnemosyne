...
- [0005 — Frontmatter backfill (Helios)](0005-frontmatter-backfill.md) — ✅ **16/17 BACKFILLED + LIVE** (2026-06-15): Helios classified all 17, Aegis security-reviewed, Atlas applied + ingested 16 (brain 117 entries / 70 chunks, run `43fcfab6` success). `intellitax.md` held out per the authoritative quarantine (revoked `sbp_` token), reverted to untouched — pending Jesse's redact-and-reingest call. Aegis reconciliation review pending.
